...
import {IAdminBattlestationSummary} from './apiQueries';


interface Props {
    battlestation: IAdminBattlestationSummary
    deleteFunction: Function
    selectFunction: Function
}

function AdminBattlestationListEntry({battlestation, deleteFunction, selectFunction}: Props) {
...
export default AdminBattlestationListEntry;